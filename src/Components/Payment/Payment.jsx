...
function Payment() {
	...
	const handlePayment = () => {
		const Pr =
			((traveller * (storedata?.act_price - storedata?.act_price * 0.3)) /
				2) *
			100;
					...
					<Box w={{ base: "100%", md: "100%", lg: "67%" }}>
								...
								>
									<Flex py={"5px"}>
										...
										<Text pt={"5px"} px={"10px"}>
											...
											upfront per person The remaining
											amount will be due on Oct 1st, 2023
										</Text>
									</Flex>
									<Flex py={"5px"}>
										<FaUserFriends size={"25px"} />
										<Text px={"10px"}>
											A few spaces left and yours is
											reserved for the next 10 minutes
										</Text>
									</Flex>
									<Flex py={"5px"}>
										<BsLightningChargeFill size={"22px"} />
										<Text px={"10px"}>
											Instant Book: Your spaces will be
											instantly secured.
										</Text>
									</Flex>
									<Flex py={"5px"}>
						...
						>
							...
							>
								...
								>
									...
									<Text>
										{" "}
										Traveller details should match
						...
						>
							...
							>
								...
								<Text
									...
									color={theme ? "white" : "blackAlpha.800"}
								>
									This is a secure and SSL encrypted payment.
						...
						>
							...
							<Text
								...
								fontSize={"13px"}
							>
								Voyawondar is an authorised Agent of Expat
								Explore Travel. Please familiarise yourself with
								the Expat Explore Travel payment, cancellation
								and refund policies and Voyawondar's Terms &
								Conditions. Voyawondar will charge you in the
								stated currency and we do not charge any booking
								fees.
							</Text>
						</Box>
					</Box>
	...
	return (
		...
		>
			...
			<Flex justifyContent={"space-between"}>
				...
				<Text>
					₹{" "}
					{(traveller * storedata?.act_price)?.toLocaleString(
						"en-US"
					)}
				</Text>
			</Flex>
			...
			>
				...
				<Text>
					- ₹{" "}
					{(traveller * storedata?.act_price * 0.3)?.toLocaleString(
						"en-US"
					)}
				</Text>
			</Flex>
